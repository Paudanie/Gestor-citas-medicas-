...
from .models import *
from .forms import RegistroForm, FuncionarioForm, DoctorForm, PacienteForm
...
def registro_usuario(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # 2️⃣ Crear el perfil según el codigo_seguridad
            ...
            # 3️⃣ Redirigir a la página que quieras
